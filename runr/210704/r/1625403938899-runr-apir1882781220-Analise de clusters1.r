...
#LEITURA DOS DADOS
dados <- read.table("C:/Users/ANTONIO/Google Drive/DATA SCIENCE/DATASETS/dados winequality-red.csv", sep = ",", header = T, dec = ".")
View(dados)
...
mcdonalds <- read.table("C:/Users/apira/Box Sync/CURSOS/MBA ESALQ USP/Datasets e projetosR/Nao_Supervisionado_USP/dados/MCDONALDS.csv", sep = ";", dec = ",", header = T)
